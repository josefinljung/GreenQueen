...
export default function About(){
    ...
    How about a Spicy Corn and Chick Pea Burger or Smashed Avocado toast with homemade chili salsa and an ice cold beer? The food and drink we serve is mostly organic and, as we call it, "CLEAN", i.e. free from gluten, lactose and refined sugar. With us it is about being able to sin with a good conscience</p>
    )
}
